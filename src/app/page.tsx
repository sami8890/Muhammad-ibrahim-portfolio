  ...
  const portfolioItems = [
    {
      ...
      image: "/featured/first.png",
    },
    {
      title: "1 MIN VIDEO/REEL",
      image: "/featured/second.png",
    },
    {
      title: "STATIC FEED POST",
      image: "/featured/third.png",
    },
    {
      title: "STATIC FEED POST",
      image: "/featured/fourth.png",
    },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Comprehensive LinkedIn solutions to elevate your professional
      ...
      <section id="portfolio" className="py-20 lg:py-28 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
              featured <span className="text-[#b01108]">Section</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Browse through my recent projects and see how I&apos;ve helped
              professionals transform their LinkedIn presence.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-300 mb-10 text-xl">
              Join the top 5% of LinkedIn professionals in Pakistan and unlock
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center md:text-right">
              <p className="text-gray-400">
                &copy; {new Date().getFullYear()} Muhammad Ibrahim. All rights
                reserved.
              </p>
            </div>
          </div>
